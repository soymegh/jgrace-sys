<template>
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-tipos-bodegas-registrar' }">
            ...
            <table class="table table-striped table-bordered">
                ...
                <template v-for="tipo in tipos">
                    <tr :key="tipo.id_tipo_bodega">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Tipo Bodegas'"
                                             :to="{name: 'inventario-tipos-bodegas-actualizar', params: {id_tipo_bodega: tipo.id_tipo_bodega}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipos" :total="total"
