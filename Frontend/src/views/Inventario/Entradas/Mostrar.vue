                        ...
                        <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                            ...
                            <div class="mt-md-0 mt-2">
                                <h4 class="invoice-title">
                                    Entrada
                                    <span class="invoice-number">#{{ form.codigo_entrada}}</span>
                                </h4>
                    ...
                    >
                        <b-row class="invoice-spacing">
                            ...
                            <b-col cols="12" xl="4" class="p-0">
                                ...
                                <template v-if="prove">
                                  <template v-for="des in prove">
                                    <p class="card-text mb-25">
                                      {{des.nombre_comercial}}
                                    </p>
                                  </template>

<!--                                    <p class="card-text mb-25">
                                        {{form.entrada_proveedor.numero_ruc}}
                                    </p>
                                    <p class="card-text mb-25">
                                        {{form.entrada_proveedor.direccion}}
                                    </p>
                                    <h6 class="mb-25">
                                        {{ 'Contacto proveedor:' }}
                                    </h6>
                                    <p class="card-text mb-25">
                                        {{form.entrada_proveedor.contacto_proveedor}}
                                    </p>-->
                                </template>
                                <template v-else>
                                    <p class="card-text mb-25">
                            ...
                            <b-col cols="12" xl="4" class="p-0 justify-content-xl-center">
                                ...
                                <router-link style="color: #000000;"
                            ...
                            <b-col cols="12" xl="4" class="p-0 justify-content-xl-end">
                                ...
                                <p class="card-text mb-25">
                                    {{ form.fecha_recepcion ? formatDate(form.fecha_recepcion) : 'N/D'}}
                                </p>
                    ...
                    >
                        ...
                        <template #cell(cantidad_solicitada)="data">
                            <b-card-text class="font-weight-bold mb-25">
                                {{data.item.cantidad_solicitada}}
                            </b-card-text>
                        </template>
                        <template #cell(cantidad_recibida)="data">
                            <b-card-text class="font-weight-bold mb-25">
                                {{data.item.cantidad_recibida}}
                            </b-card-text>
                        </template>
                        ...
                        <template #foot(cantidad_solicitada)="data">
                            <span class="text-bold">{{ total_cantidad_solicitada }}</span>
                        </template>
                        <template #foot(cantidad_recibida)="data">
                            <span class="text-bold">{{ total_cantidad_recibida }}</span>
                        </template>
                    </b-table-lite>
            ...
            >
                <b-card>
                    ...
                    <b-button
                            ...
                            class="mb-75"
                            block
                            @click.prevent="downloadItem('pdf', form.id_entrada)"
                    >
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            downloadItem(extension, id_entrada) {
                const self = this;
                if (!this.descargando) {
                    self.loading = true;
                    let url = 'entradas/reporte/' + extension + '/' + id_entrada;
                    ...
                    axios.get(url, {responseType: 'blob'})
                        .then(({data}) => {
                            ...
                            link.download = 'FormatoControlEntrada.' + extension;
                            link.click()
