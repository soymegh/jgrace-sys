<template>
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-proveedores-registrar' }">
            ...
            <table class="table table-striped table-bordered">
                ...
                <template v-for="proveedor in proveedores">
                    <tr :key="proveedor.id_proveedor">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Proveedor'"
                                             :to="{name: 'inventario-proveedores-actualizar', params: {id_proveedor: proveedor.id_proveedor}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="proveedores" :total="total"
