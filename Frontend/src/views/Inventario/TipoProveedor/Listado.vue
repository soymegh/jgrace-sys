    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-tipos-proveedores-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="tipo_proveedor in tipos_proveedores">
                    <tr :key="tipo_proveedor.id_tipo_proveedor">
                        <td>{{ tipo_proveedor.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="tipo_proveedor.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Tipo Salidas'"
                                             :to="{name: 'inventario-tipos-proveedores-actualizar', params: {id_tipo_proveedor: tipo_proveedor.id_tipo_proveedor}}"
                                             tag="a">
                ...
                <tr v-if="!tipos_proveedores.length">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipos_proveedores" :total="total"
    ...
    export default {
        ...
        methods: {
            ...
            obtener() {
                var self = this;
                self.loading = true;
                tipo_proveedor.obtener(
                    self.filter,
                    data => {
                        self.tipos_proveedores = data.rows;
