<template>
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-marcas-registrar' }">
            ...
            <div @keyup.enter="filter.page = 1;obtener();"
                ...
                <select v-model="filter.search.field" class="form-control mb-1 mr-sm-1 mb-sm-0 search-field">
                    <option value="descripcion">Marca</option>
                </select>
            ...
            <table class="table table-striped table-bordered">
                ...
                <template v-for="marca in marcas">
                    <tr :key="marca.id_marca">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Marcas'"
                                             :to="{name: 'inventario-marcas-actualizar', params: {id_marca: marca.id_marca}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="marcas" :total="total"
