            ...
            <b-row>
                <div class="col-md-6 text-left p-0">
                    <template v-if="form.estado">
                        <b-button type="submit" variant="danger" @click="desactivar(form.id_tipo_salida)">
                            <feather-icon icon="Trash2Icon"></feather-icon> Eliminar
                        </b-button>
                    </template>
                    <template v-else>
                        <b-button type="submit" variant="success" @click="activar(form.id_tipo_salida)">
                ...
                <div class="col-md-6">
                    <router-link  :to="{name: 'inventario-tipos-salidas'}">
...
<script type="text/ecmascript-6">
    ...
    import tipo_salida from "../../../api/Inventario/tipos_salidas";
    ...
    export default {
        ...
        methods: {
            ...
            actualizar(){
                ...
                self.loading = true;
                tipo_salida.actualizar(self.form, data =>{
                        self.loading = false;
                        this.$toast({
                                component : ToastificationContent,
                                props: {
            ...
            activar(tipoSalidaID){
                var self = this;
                self.$swal({
                    title: '¿Esta seguro?',
                    text: '¿ Desea activar el tipo de salida?',
                    icon: 'info',
                    ...
                    if (result.value){
                        self.$swal({
                            icon :'success',
                            title : '¡Habilitada!',
                            text : '¡Tipo de salida habilitada!',
                            customClass: {
                                confirmButton : 'btn btn-success',
                            }
                        });
                        tipo_salida.activar({
                            id_tipo_salida: tipoSalidaID
                        }, data =>{
                            this.$router.push({
                                name : 'inventario-tipos-salidas'
                            })
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El tipo de salida no ha sido habilitada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
            ...
            desactivar(tipoSalidaID){
                var self = this;
                self.$swal({
                    title: 'Info!',
                    text: '¿Esta seguro de desactivar el tipo de salida?',
                    icon: 'info',
                    showCancelButton: true,
                    confirmButtonText : 'Si, confirmar',
                    cancelButtonText : 'Cancelar',
                    ...
                    if (result.value){
                        self.$swal({
                            icon :'success',
                            title : '¡Eliminada!',
                            text : '¡Tipo de salida eliminada!',
                            customClass: {
                                confirmButton : 'btn btn-success',
                            }
                        });
                        tipo_salida.desactivar({id_tipo_salida: tipoSalidaID
                            },
                            data =>{
                                this.$router.push({
                                    name : 'inventario-tipos-salidas'
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El tipo de salida no ha sido eliminada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
