    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-tipos-salidas-registrar' }">
            ...
            <div @keyup.enter="filter.page = 1;obtener();"
                ...
                <select v-model="filter.search.field" class="form-control mb-1 mr-sm-1 mb-sm-0 search-field">
                    <option value="descripcion">Tipo Salida</option>
                </select>
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="tipo_salida in tipos_salidas">
                    <tr :key="tipo_salida.id_tipo_salida">
                        <td>{{ tipo_salida.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="tipo_salida.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Tipo Salidas'"
                                             :to="{name: 'inventario-tipos-salidas-actualizar', params: {id_tipo_salida: tipo_salida.id_tipo_salida}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipos_salidas" :total="total"
