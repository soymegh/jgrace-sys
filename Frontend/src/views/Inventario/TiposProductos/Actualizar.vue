            ...
            <b-row>
                <div class="col-md-6 text-left p-0">
                    <template v-if="form.estado">
                        <b-button type="submit" variant="danger" @click="desactivar(form.id_tipo_producto)">
                            <feather-icon icon="Trash2Icon"></feather-icon> Eliminar
                        </b-button>
                    </template>
                    <template v-else>
                        <b-button type="submit" variant="success" @click="activar(form.id_tipo_producto)">
                ...
                <div class="col-md-6">
                    <router-link  :to="{name: 'inventario-tipos-productos'}">
...
<script type="text/ecmascript-6">
    ...
    import tipo_producto from "../../../api/Inventario/tipos_productos";
    ...
    export default {
        ...
        methods: {
            ...
            obtenerTipoProducto(){
                var self = this;
                tipo_producto.obtenerTipoProducto({
                    id_tipo_producto: this.$route.params.id_tipo_producto
                }, data =>{
                    self.form = data;
                    self.loading = false;
                }, err =>{
            ...
            actualizar(){
                ...
                self.loading = true;
                tipo_producto.actualizar(self.form, data =>{
                        self.loading = false;
                        this.$toast({
                            component : ToastificationContent,
                            props: {
            ...
            activar(tipoProductoID){
                var self = this;
                self.$swal({
                    title: '¿Esta seguro?',
                    text: '¿ Desea activar el tipo de producto?',
                    icon: 'info',
                    ...
                    if (result.value){
                        self.$swal({
                            icon :'success',
                            title : '¡Habilitado!',
                            text : '¡Tipo producto habilitada!',
                            customClass: {
                                confirmButton : 'btn btn-success',
                            }
                        });
                        tipo_producto.activar({
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El tipo de producto no ha sido habilitada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
            ...
            desactivar(tipoProductoID){
                var self = this;
                self.$swal({
                    title: 'Info!',
                    text: '¿Esta seguro de desactivar el tipo de producto?',
                    icon: 'info',
                    showCancelButton: true,
                    confirmButtonText : 'Si, confirmar',
                    cancelButtonText : 'Cancelar',
                    ...
                    if (result.value){
                        ...
                        tipo_producto.desactivar({id_tipo_producto: tipoProductoID
                            },
                            data =>{
                                this.$router.push({
                                    name : 'inventario-tipos-productos'
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El tipo de producto no ha sido eliminada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
