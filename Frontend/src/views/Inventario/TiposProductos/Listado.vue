    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-tipos-productos-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="tipo_producto in tipos_productos">
                    <tr :key="tipo_producto.id_tipo_bodega">
                        <td>{{ tipo_producto.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="tipo_producto.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Tipo Producto'"
                                             :to="{name: 'inventario-tipos-productos-actualizar', params: {id_tipo_producto: tipo_producto.id_tipo_producto}}"
                                             tag="a">
                ...
                <tr v-if="!tipos_productos.length">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipos_productos" :total="total"
    ...
    export default {
        ...
        methods: {
            ...
            obtener() {
                var self = this;
                self.loading = true;
                tipo_producto.obtener(
                    self.filter,
                    data => {
                        self.tipos_productos = data.rows;
