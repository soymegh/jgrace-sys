    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-tipos-entradas-registrar' }">
            ...
            <div @keyup.enter="filter.page = 1;obtener();"
                ...
                <select v-model="filter.search.field" class="form-control mb-1 mr-sm-1 mb-sm-0 search-field">
                    <option value="descripcion">Tipo Entrada</option>
                </select>
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="tipo_entrada in tipos_entradas">
                    <tr :key="tipo_entrada.id_tipo_entrada">
                        <td>{{ tipo_entrada.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="tipo_entrada.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Tipo Entradas'"
                                             :to="{name: 'inventario-tipos-entradas-actualizar', params: {id_tipo_entrada: tipo_entrada.id_tipo_entrada}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipos_entradas" :total="total"
    ...
    export default {
        ...
        methods: {
            ...
            obtener() {
                var self = this;
                self.loading = true;
                tipo_entrada.obtener(
                    self.filter,
                    data => {
                        self.tipos_entradas = data.rows;
