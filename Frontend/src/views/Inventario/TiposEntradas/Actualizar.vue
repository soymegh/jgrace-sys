            ...
            <b-row>
                <div class="col-md-6 text-left p-0">
                    <template v-if="form.estado">
                        <b-button type="submit" variant="danger" @click="desactivar(form.id_tipo_entrada)">
                            <feather-icon icon="Trash2Icon"></feather-icon> Eliminar
                        </b-button>
                    </template>
                    <template v-else>
                        <b-button type="submit" variant="success" @click="activar(form.id_tipo_entrada)">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            obtenerTipoEntrada(){
                var self = this;
                tipo_entrada.obtenerTipoEntrada({
                    id_tipo_entrada: this.$route.params.id_tipo_entrada
                }, data =>{
                    self.form = data;
                    self.loading = false;
                }, err =>{
            ...
            actualizar(){
                ...
                self.loading = true;
                tipo_entrada.actualizar(self.form, data =>{
                        self.loading = false;
                        this.$toast({
                            component : ToastificationContent,
                            props: {
            ...
            activar(tipoEntradaID){
                var self = this;
                self.$swal({
                    title: '¿Esta seguro?',
                    text: '¿ Desea activar el tipo de entrada?',
                    icon: 'info',
                    ...
                    if (result.value){
                        self.$swal({
                            icon :'success',
                            title : '¡Habilitada!',
                            text : '¡Tipo de entrada habilitada!',
                            customClass: {
                                confirmButton : 'btn btn-success',
                            }
                        });
                        tipo_entrada.activar({
                            id_tipo_entrada: tipoEntradaID
                        }, data =>{
                            this.$router.push({
                                name : 'inventario-tipos-entradas'
                            })
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El tipo de entrada no ha sido habilitada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
            ...
            desactivar(tipoEntradaID){
                var self = this;
                self.$swal({
                    title: 'Info!',
                    text: '¿Esta seguro de desactivar el tipo de entrada?',
                    icon: 'info',
                    showCancelButton: true,
                    confirmButtonText : 'Si, confirmar',
                    cancelButtonText : 'Cancelar',
                    ...
                    if (result.value){
                        self.$swal({
                            icon :'success',
                            title : '¡Eliminada!',
                            text : '¡Tipo de entrada eliminada!',
                            customClass: {
                                confirmButton : 'btn btn-success',
                            }
                        });
                        tipo_entrada.desactivar({id_tipo_entrada: tipoEntradaID
                            },
                            data =>{
                                this.$router.push({
                                    name : 'inventario-tipos-entradas'
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El tipo de entrada no ha sido eliminada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
