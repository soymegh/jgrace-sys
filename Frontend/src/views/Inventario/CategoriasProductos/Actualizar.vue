            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" v-model="form.nombre_categoria" placeholder="Dígite la marca">
                        <b-alert variant="danger" show>
                            <ul class="error-messages">
                                <li v-for="message in errorMessages.nombre_categoria">{{ message }}</li>
                            </ul>
                        </b-alert>
            ...
            <b-row>
                <div class="col-md-6 text-left p-0">
                    <template v-if="form.estado">
                        <b-button type="submit" variant="danger" @click="desactivar(form.id_categoria)">
                            <feather-icon icon="Trash2Icon"></feather-icon> Eliminar
                        </b-button>
                    </template>
                    <template v-else>
                        <b-button type="submit" variant="success" @click="activar(form.id_categoria)">
                ...
                <div class="col-md-6">
                    <router-link  :to="{name: 'inventario-categorias-productos'}">
...
<script type="text/ecmascript-6">
    ...
    import categoria_producto from "../../../api/Inventario/categorias_productos";
    ...
    export default {
        ...
        methods: {
            ...
            obtenerCategoria(){
                var self = this;
                categoria_producto.obtenerCategoria({
            ...
            actualizar(){
                ...
                self.loading = true;
                categoria_producto.actualizar(self.form, data =>{
                        self.loading = false;
                        this.$toast({
                                component : ToastificationContent,
                                props: {
            ...
            activar(categoriaProductoID){
                ...
                self.$swal({
                    ...
                    if (result.value){
                        ...
                        categoria_producto.activar({
                            id_categoria: categoriaProductoID
                        }, data =>{
                            this.$router.push({
                                name : 'inventario-categorias-productos'
                            })
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'La categoría no ha sido habilitada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
            ...
            desactivar(categoriaProductoID){
                var self = this;
                self.$swal({
                    title: 'Info!',
                    text: '¿Esta seguro de desactivar la cetegoría?',
                    icon: 'info',
                    showCancelButton: true,
                    confirmButtonText : 'Si, confirmar',
                    cancelButtonText : 'Cancelar',
                    ...
                    if (result.value){
                        ...
                        categoria_producto.desactivar({id_categoria: categoriaProductoID
                            },
                            data =>{
                                this.$router.push({
                                    name : 'inventario-categorias-productos'
