    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'inventario-categorias-productos-registrar' }">
            ...
            <div @keyup.enter="filter.page = 1;obtener();"
                ...
                <select v-model="filter.search.field" class="form-control mb-1 mr-sm-1 mb-sm-0 search-field">
                    <option value="nombre_categoria">Nombre de la categoria</option>
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="categoria_producto in categorias_productos">
                    <tr :key="categoria_producto.id_categoria">
                        <td>{{ categoria_producto.nombre_categoria }}</td>
                        <td>{{ categoria_producto.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="categoria_producto.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Categoría Producto'"
                                             :to="{name: 'inventario-categorias-productos-actualizar', params: {id_categoria: categoria_producto.id_categoria}}"
                                             tag="a">
                ...
                <tr v-if="!categorias_productos.length">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="categorias_productos" :total="total"
    ...
    export default {
        ...
        methods: {
            ...
            obtener() {
                var self = this;
                self.loading = true;
                categoria_producto.obtener(
                    self.filter,
                    data => {
                        self.categorias_productos = data.rows;
