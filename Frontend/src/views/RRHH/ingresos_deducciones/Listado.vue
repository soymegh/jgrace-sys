	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar ingresos y deducciones</div>
				<div class="box-description">Listado de ingreso y deducciones</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-nomina' }"> Módulo nomina</router-link>> Ingreso</div>
			</div>
			<div class="row">
	...
	export default {
		...
		methods: {
			...
			obtener() {
				var self = this
				self.loading = true;
				ingreso.obtenerIngresosDeducciones(self.filter, data => {
