        ...
        <b-card>
            <div class="row">
                <div class="col-md-3 small-text-center">
                    <router-link class="btn btn-success" tag="button" :to="{name:'contabilidad-centros-costos-registrar'}">
            ...
            <div class="table-responsive mt-3">
                <table class="table table-striped table-bordered">
                    <thead>
                    <tr>
                        <th class="text-center">Tipo centro</th>
                    ...
                    <tbody>
                    <tr v-for="centro_costo in centros" :key="centro_costo.id_centro">
                        <template v-if="centro_costo.tipo_centro === 2">
                            <td>Centro de costos</td>
                        </template>
                        <template v-else>
                            <td>Centro de ingresos</td>
                        </template>
                        <td class="text-center">{{ centro_costo.codigo}}</td>
                        <td class="text-center">{{centro_costo.descripcion}}</td>
                        <td class="text-center">
                            <div v-if="centro_costo.estado">
                        ...
                        <td class="text-center">
                            <router-link  :to="{ name: 'contabilidad-centros-costos-actualizar', params: { id_centro: centro_costo.id_centro}}"><feather-icon icon="EditIcon"></feather-icon></router-link>
                        </td>
                    </tr>
                    <tr v-if="!centros.length">
            ...
            <b-card-footer>
                <pagination class="pagination b-pagination mb-0" @changePage="changePage" @changeLimit="changeLimit" :items="centros" :total="total" :page="filter.page" :limitOptions="filter.limitOptions" :limit="filter.limit"></pagination>
            </b-card-footer>
    ...
    export default {
        ...
        methods: {
            ...
            obtener() {
                var self = this;
                self.loading = true;
                centro_costo.obtener(self.filter, data => {
