                        ...
                        <div class="col-md-6">
                            <table class="table table-responsive-md ">
                                ...
                                <tr :key="cuentaContable.id_cierre_mensual" v-for="cuentaContable in cuentasContablesActivos">
                                    <td class="text-center" style="padding-left: 1em" v-if="cuentaContable.id_nivel_cuenta === 2" >{{ cuentaContable.cta_contable }}</td>
                                    <td class="text-center" v-if="cuentaContable.id_nivel_cuenta === 3" ><strong>{{ cuentaContable.cta_contable }}</strong></td>
                                    <td class="text-center" style="padding-left: 3em" v-if="cuentaContable.id_nivel_cuenta === 4">{{ cuentaContable.cta_contable }}</td>
                                    <td class="text-center" v-if="cuentaContable.id_nivel_cuenta === 5">{{ cuentaContable.cta_contable }}</td>
                                    <td class="text-center" v-if="cuentaContable.id_nivel_cuenta === 6">{{ cuentaContable.cta_contable }}</td>
<!--                                    <td class="text-center" v-if="cuentaContable.id_nivel_cuenta === 3">{{ cuentaContable.cta_contable }}</td>-->
                                    <td class="text-left" style="padding-left: 1em" v-if="cuentaContable.id_nivel_cuenta === 2" >{{ cuentaContable.nombre_cuenta }}</td>
                                    <td class="text-left" v-if="cuentaContable.id_nivel_cuenta === 3" ><strong>{{ cuentaContable.nombre_cuenta }}</strong></td>
                                    <td class="text-left" style="padding-left:3em" v-if="cuentaContable.id_nivel_cuenta === 4">{{ cuentaContable.nombre_cuenta }}</td>
                                    <td class="text-left" style="padding-left:2em" v-if="cuentaContable.id_nivel_cuenta === 5">{{ cuentaContable.nombre_cuenta }}</td>
                                    <td class="text-left" style="padding-left:2em" v-if="cuentaContable.id_nivel_cuenta === 6">{{ cuentaContable.nombre_cuenta }}</td>
<!--                                    <td class="text-left" style="padding-left:2em" v-if="cuentaContable.id_nivel_cuenta === 3">{{ cuentaContable.nombre_cuenta }}</td>-->
                                    <td class="text-center" v-if="cuentaContable.id_nivel_cuenta === 3" ><strong>{{ Number(cuentaContable.saldox) | formatMoney(2)}}</strong></td>
                                    <td class="text-center" v-else>{{ Number(cuentaContable.saldox) | formatMoney(2)}}</td>
                        ...
                        <div class="col-md-6">
                            <table class="table table-responsive-md ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-right table-number"><strong> {{total_activos | formatMoney(2)}}</strong></th>
                                </tr>
                                </thead>
                                <tbody>
                                </tbody>
                        ...
                        <div class="col-md-6">
                            <table class="table table-responsive-md ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-right table-number"><strong> {{total_pasivos_capital | formatMoney(2)}}</strong></th>
                                </tr>
                                </thead>
                                <tbody>
                                </tbody>
