            ...
            <form>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <b-form-select class="form-control" v-model.number="filter.id_tipo_configuracion"
                                    @change="cargar()">
                                <option value="1">Recibo para pago factura de crédito</option>
                                <option value="2">Anticipo de Clientes</option>
                                <option value="3">Recibo para pago factura de contado</option>
                                <!--<option value="4">Entrada por compra de usados</option>
                                <option value="5">Entradas locales acreedores</option  >
                               <option value="6">Ajuste garantia parcial</option>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                        <tr v-for="configuracion in form.ajustes" :key="configuracion.id_configuracion_contabilidad">

                            <!--<td>
                                <template
                                        v-if="configuracion.configuracion_cuenta_contable.requiere_aux === 0">
                                ...
                                <template
                                        v-if="configuracion.configuracion_cuenta_contable.requiere_aux === 1">
                                ...
                                <template
                                        v-if="configuracion.configuracion_cuenta_contable.requiere_aux === 2">
                                ...
                                <template
                                        v-if="configuracion.configuracion_cuenta_contable.requiere_aux === 3">
                            ...
                            <td class="text-left">
                                <v-select :options="cuentas_contables" label="nombre_cuenta_completo"
                                          v-model="configuracion.configuracion_cuenta_contable"></v-select>
                            </td>
...
<script type="text/ecmascript-6">
    ...
    import { BPaginationNav,BFormCheckbox,BFormGroup,BCard, BCardFooter, BRow, BButton, BFormSelect } from 'bootstrap-vue'
    //import ToastificationContent from "../../../@core/components/toastification/ToastificationContent";
    import vSelect from 'vue-select'
    import importacionConf from "../../../api/contabilidad/configuracion_comprobantes";
                    ...
                    err => {
                        this.$toast({
                            ...
                            props: {
                                title: 'Notificación',
                                icon: 'CheckIcon',
                                text: 'Verifique que ningún campo requerido esté vacío',
                                variant: 'warning',
                            }
                        },
                        {
