    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'contabilidad-cuentas-bancarias-registrar' }">
                    <feather-icon icon="PlusCircleIcon"></feather-icon>
                    Registrar
                </router-link>
            </div>

            <div @keyup.enter="filter.page = 1;obtenerCuentasbancarias();"
                ...
                <input v-model="filter.search.value" class="form-control mb-1 mr-sm-1 mb-sm-0" placeholder="Buscar"
                       type="text">
                <b-button variant="info" @click="filter.page = 1;obtenerCuentasbancarias();"
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="cuenta_bancaria in cuentas_bancarias">
                    <tr :key="cuenta_bancaria.id_cuenta_bancaria">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Cuenta Bancaria'"
                                             :to="{name: 'contabilidad-cuentas-bancarias-actualizar', params: {id_cuenta_bancaria: cuenta_bancaria.id_cuenta_bancaria}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="cuentas_bancarias" :total="total"
    ...
    export default {
        ...
        methods: {
            ...
            obtenerCuentasbancarias() {
                var self = this;
                self.loading = true;
                cuenta_bancaria.obtenerCuentasBancarias(
                    self.filter,
                    data => {
