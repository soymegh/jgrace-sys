    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'admon-impuestos-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="impuesto in impuestos">
                    <tr :key="impuesto.id_impuesto">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar impuesto'"
                                             :to="{name: 'admon-impuestos-actualizar', params: {id_impuesto: impuesto.id_impuesto}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="impuestos" :total="total"
