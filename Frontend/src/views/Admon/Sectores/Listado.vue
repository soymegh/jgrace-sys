    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <!--<router-link class="btn btn-success" tag="button"
                             :to="{ name: 'admon-sectores-registrar' }">
            ...
            <div @keyup.enter="filter.page = 1;obtener();"
                ...
                <select v-model="filter.search.field" class="form-control mb-1 mr-sm-1 mb-sm-0 search-field">
                    <option value="descripcion">Sector</option>
                </select>
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="sector in sectores">
                    <tr :key="sector.id_sector">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Ver Sector'"
                                             :to="{name: 'admon-sectores-actualizar', params: {id_sector: sector.id_sector}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="sectores" :total="total"
