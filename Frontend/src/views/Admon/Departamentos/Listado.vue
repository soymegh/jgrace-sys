    ...
    <b-card>
        <b-row>
            <div class="col-md-4 sm-text-center">
                <router-link :to="{ name: 'admon-departamentos-registrar' }" class="btn btn-success" tag="button">
                    <i class="pe-7s-plus"></i> Registrar
                </router-link>
            </div>
            <div @keyup.enter="filter.page = 1;obtenerDepartamentos();"
                ...
                <b-button class="btn btn-info mx-1" style="margin-right: .5rem!important;"
                          v-b-tooltip.hover.top="'Buscar departamento!'"
                          @click="filter.page = 1; obtenerDepartamentos();">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tr :key="departamento.id_departamento" v-for="departamento in departamentos">
                    ...
                    <td class="text-center">
                        <router-link tag="a" :to="{ name: 'admon-departamentos-actualizar', params: { id_departamento: departamento.id_departamento } }" v-b-tooltip.hover.top="'Editar registro!'"><feather-icon icon="EditIcon"></feather-icon></router-link>
                    </td>
                </tr>
        ...
        <b-card-footer>
            <pagination :items="departamentos" :limit="filter.limit" :limitOptions="filter.limitOptions" :page="filter.page"
    ...
    export default {
        ...
        methods: {
            obtenerDepartamentos() {
                var self = this;
                self.loading = true;
                departamentos.obtener(self.filter, data => {
