    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'ventas-tipos-clientes-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="tipo_cliente in tipos_clientes">
                    <tr :key="tipo_cliente.id_tipo_cliente">
                        <td>{{ tipo_cliente.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="tipo_cliente.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Tipo Cliente'"
                                             :to="{name: 'ventas-tipos-clientes-actualizar', params: {id_tipo_cliente: tipo_cliente.id_tipo_cliente}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipos_clientes" :total="total"
    ...
    export default {
        ...
        methods: {
            ...
            obtener() {
                var self = this;
                self.loading = true;
                tipo_cliente.obtener(
                    self.filter,
                    data => {
                        self.tipos_clientes = data.rows;
