<template>
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'ventas-vendedores-registrar' }">
            ...
            <table class="table table-striped table-bordered">
                ...
                <template v-for="vendedor in vendedores">
                    <tr :key="vendedor.id_vendedor">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Vendedor'"
                                             :to="{name: 'ventas-vendedores-actualizar', params: {id_vendedor: vendedor.id_vendedor}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="vendedores" :total="total"
