export default {
    ...
    obtener(data, cb, errorCb) {
        axios.post('via-pago/obtener', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    obtenerViaPago(data, cb, errorCb) {
        axios.post('via-pago/obtener-via-pago', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    registrar(data, cb, errorCb) {
        axios.post('via-pago/registrar', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    actualizar(data, cb, errorCb) {
        axios.put('via-pago/actualizar', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    desactivar(data, cb, errorCb) {
        axios.put('via-pago/desactivar', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    activar(data, cb, errorCb) {
        axios.put('via-pago/activar', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
