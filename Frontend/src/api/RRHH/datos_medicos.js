export default {
    obtenerTodas(cb, errorCb) {
        axios.get('datos-medicos/obtener-todas')
    ...
    obtener(data, cb, errorCb) {
        axios.post('datos-medicos/obtener', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    obtenerDatoMedico(data, cb, errorCb) {
        axios.post('datos-medicos/obtener-datos', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
